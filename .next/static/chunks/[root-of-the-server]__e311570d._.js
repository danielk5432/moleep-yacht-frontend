...
"[project]/src/utils/calculateScores.ts [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/ScoreTable.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$calculateScores$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/calculateScores.ts [client] (ecmascript)");
'use client';
;
;
;
const ScoreTable = ({ dice })=>{
    const scores = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$calculateScores$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["calculateScores"])(dice);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: Object.entries(scores).map(([category, score])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].Fragment, {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ScoreTable$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ScoreTable.tsx [client] (ecmascript)");
;
...
const DiceRoller = ()=>{
    ...
    const selectedDiceMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    const [topFaces, setTopFaces] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [rollCount, setRollCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    function getDynamicFixedPositions(n) {
        ...
        const positions = [];
        for(let i = 0; i < n; i++){
            positions.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](x, y, startZ + i * spacing));
        }
        return positions;
    }
    const throwDice = ()=>{
        ...
        diceArrayRef.current.forEach((d, i)=>{
            ...
            d.body.type = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Body"].DYNAMIC;
            d.body.allowSleep = true;
            d.body.velocity.setZero();
            d.body.angularVelocity.setZero();
            d.mesh.position.copy(d.body.position);
            const impulse = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vec3"]((Math.random() - 0.5) * 2, 20 + Math.random() * 5, (Math.random() - 0.5) * 2 // Z 방향: 약간의 흔들림
            );
            const contactPoint = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vec3"](0, 0, 0.2); // 중심에서 약간 위쪽
    ...
    const handleResetAndThrow = ()=>{
        ...
        for (const d of diceArrayRef.current){
            ...
            d.body.angularVelocity.setZero();
            // 초기 위치로 재배치
            d.body.position = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vec3"](4, i * 1.5, 0);
            d.mesh.position.copy(d.body.position);
            i += 1;
            // 회전 무작위 설정
            d.mesh.rotation.set(2 * Math.PI * Math.random(), 0, 2 * Math.PI * Math.random());
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DiceRoller.useEffect": ()=>{
                ...
                "DiceRoller.useEffect.render": ()=>{
                    ...
                    for (const dice of diceArrayRef.current){
                        ...
                        if (dice.targetPosition) {
                            ...
                            if (dist > 0.4) {
                                const direction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"]().subVectors(target, current).normalize();
                                ...
                                dice.body.position.copy(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vec3"](target.x, target.y, target.z));
                    ...
                    if (allSleeping && allArrived && !scored) {
                        ...
                        if (selectedDiceList.length > 0) {
                            const faces = selectedDiceList.map({
                                "DiceRoller.useEffect.render.faces": (d)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTopFaceNumber$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getTopFaceNumber"])(d.mesh.quaternion)
                            }["DiceRoller.useEffect.render.faces"]);
            ...
            const initialThrow = {
                "DiceRoller.useEffect.initialThrow": ()=>{
                    if (rollCount >= maxRollCount) return;
                    scored = false;
                    if (!scoreResult) return;
                    scoreResult.innerHTML = '';
                    diceArrayRef.current.forEach({
                        "DiceRoller.useEffect.initialThrow": (d, i)=>{
                    ...
                    setRollCount({
                        "DiceRoller.useEffect.initialThrow": (prev)=>prev + 1
                    }["DiceRoller.useEffect.initialThrow"]);
                }
            }["DiceRoller.useEffect.initialThrow"];
            ...
            const onClick = {
                "DiceRoller.useEffect.onClick": (event)=>{
                    ...
                    if (clickedDice.selected) {
                        ...
                        if (original) {
                            clickedDice.targetPosition = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](original.x, original.y, original.z);
                        }
                        ...
                        setSelectedDiceMap({
                            "DiceRoller.useEffect.onClick": (prev)=>{
                                ...
                                updated.forEach({
                                    "DiceRoller.useEffect.onClick": (d, i)=>{
                        ...
                        Array.from(selectedDiceMapRef.current.values()).forEach({
                            "DiceRoller.useEffect.onClick": (d, index)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            topFaces.length >= 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute left-8 top-20 z-10",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ScoreTable$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                    dice: topFaces
                }, void 0, false, {
                    fileName: "[project]/src/components/DiceRoller.tsx",
                    lineNumber: 462,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: `ml-4 px-4 py-2 rounded shadow text-white ${rollCount >= maxRollCount ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'}`,
                        children: [
                            "Throw the Dice (",
                            rollCount,
                            "/",
...
_s(DiceRoller, "LTep3TdICrgAQQhO9d4Z5WsRKOs=");
_c = DiceRoller;
...
const Dice = ()=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DiceRoller$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e311570d._.js.map